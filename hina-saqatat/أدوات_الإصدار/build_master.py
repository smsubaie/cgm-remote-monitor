...
BANNED = [
    ...
    ('إخبار بالمستقبل', __import__('re').compile(r'وسيأتي|وستأتي|وسيجيء|ستدور|وسيكون ذلك|سيتحدث بها|ولذلك خبر|لم تقض بعد|ستكشفه|ستصير أصلا|وسيعود الاسم|ستمر العقود|وستمر بالصحيفة|سيطوف به|وسيكون لخروجهم|سينخزل|خبر قريب')),
